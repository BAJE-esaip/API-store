...
class LocalSaleCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('localSaleItemsSummary', 'Produits')
                ->setVirtual(true)
                ->formatValue(static function ($value, $entity): string {
                    if ($entity === null || !method_exists($entity, 'getLocalSaleItems')) {
                        return '';
                    }
                    ...
                    $rows = [];
                    foreach ($entity->getLocalSaleItems() as $item) {
    ...
    {
        $formBuilder->add('localSaleItems', CollectionType::class, [
