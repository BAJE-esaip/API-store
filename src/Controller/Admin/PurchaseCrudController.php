...
class PurchaseCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('purchaseItemsSummary', 'Produits')
                ->setVirtual(true)
                ->formatValue(static function ($value, $entity): string {
                    if ($entity === null || !method_exists($entity, 'getPurchaseItems')) {
                        return '';
                    }
                    ...
                    foreach ($entity->getPurchaseItems() as $item) {
                        ...
                        $rows[] = sprintf(
                            ...
                            $formatNumber($item->getUnitPriceAtPurchase())
                        );
                    }
    ...
    {
        $formBuilder->add('purchaseItems', CollectionType::class, [
